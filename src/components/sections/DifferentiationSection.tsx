export const DifferentiationSection = () => {
  const features = [
    {
      title: "과학적 근거 기반",
      description: "의학, 카이로프랙틱, 중의학, 신경과학, 정골의학의 통합. 20년 이상의 임상 연구 결과와 X-ray, JSST 등 객관적 진단 도구를 활용합니다.",
    },
    {
      title: "실전 중심 교육",
      description: "이론 40% + 실습 60%. 1박 2일 집중 과정(4회)과 소규모 그룹 1:1 피드백. 평생 회원 교육으로 지속적 성장을 보장합니다.",
    },
    {
      title: "안전하고 간결한 치료",
