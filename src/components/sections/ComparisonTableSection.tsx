                ...
                <table className="w-full">
                    ...
                    <tr className="border-b-2">
                      ...
                      <th className="p-6 text-center bg-primary/10 font-bold text-lg w-1/3">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <span className="text-primary">JSHA 마스터 코스</span>
                        </div>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {comparisons.map((item, index) => (
                      ...
                      >
                        <td className="p-6 font-semibold text-foreground">{item.category}</td>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-foreground font-semibold">{item.jsha}</div>
                      </div>
                    </div>
                  </div>
                </CardContent>
            ...
            <Card className="bg-gradient-to-br from-primary/10 to-accent/10 border-2 border-primary/20">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">
                  일회성 세미나가 아닌 <strong className="text-foreground">4개월간의 체계적 교육</strong>과{" "}
                  <strong className="text-foreground">평생 지원 시스템</strong>으로 <br />
